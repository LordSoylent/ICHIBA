                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzICAPathCustom = GetArg("-zicabackuppath", "");
    ...
    if(!strzICAPathCustom.empty()) {
        ui->wallet_customzicabackuppath->setText(QString::fromStdString(strzICAPathCustom));
        ui->wallet_customzicabackuppath_label->setVisible(true);
        ui->wallet_customzicabackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzICAPathCustom.empty()) && nCustomBackupThreshold > 0) {
