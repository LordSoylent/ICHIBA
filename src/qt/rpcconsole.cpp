                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzICHPathCustom = GetArg("-zichbackuppath", "");
    ...
    if(!strzICHPathCustom.empty()) {
        ui->wallet_customzichbackuppath->setText(QString::fromStdString(strzICHPathCustom));
        ui->wallet_customzichbackuppath_label->setVisible(true);
        ui->wallet_customzichbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzICHPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the IchibaCoin RPC console.") + "<br>" +
