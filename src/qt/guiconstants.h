...
/* IchibaCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "IchibaCoin"
#define QAPP_ORG_DOMAIN "ichibacoin.org"
#define QAPP_APP_NAME_DEFAULT "IchibaCoin-Qt"
#define QAPP_APP_NAME_TESTNET "IchibaCoin-Qt-testnet"
