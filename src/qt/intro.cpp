...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("IchibaCoin"),
     ...
     * override -datadir in the ichibacoin.conf file in the default data directory
     * (to be consistent with ichibacoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
