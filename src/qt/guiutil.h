...
/** Utility functions used by the IchibaCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render IchibaCoin addresses in monospace font
...
// Parse "ichibacoin:" URI into recipient object, return true on successful parsing
