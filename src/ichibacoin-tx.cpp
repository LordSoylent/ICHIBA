...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("IchibaCoin ichibacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ichibacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ichibacoin transaction") + "\n" +
                               "  ichibacoin-tx [options] -create [commands]   " + _("Create hex-encoded ichibacoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ichibacoin transaction
