...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop IchibaCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "IchibaCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* IchibaCoin features */
        {"ichibacoin", "masternode", &masternode, true, true, false},
        {"ichibacoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ichibacoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ichibacoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ichibacoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ichibacoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ichibacoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ichibacoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ichibacoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ichibacoin", "startmasternode", &startmasternode, true, true, false},
        {"ichibacoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ichibacoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ichibacoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ichibacoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ichibacoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ichibacoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ichibacoin", "mnbudget", &mnbudget, true, true, false},
        {"ichibacoin", "preparebudget", &preparebudget, true, true, false},
        {"ichibacoin", "submitbudget", &submitbudget, true, true, false},
        {"ichibacoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ichibacoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ichibacoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ichibacoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ichibacoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ichibacoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ichibacoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ichibacoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ichibacoin", "mnsync", &mnsync, true, true, false},
        {"ichibacoin", "spork", &spork, true, true, false},
        {"ichibacoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzicaseed", &getzicaseed, false, false, true},
        {"zerocoin", "setzicaseed", &setzicaseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzica", &searchdzica, false, false, true},
        {"zerocoin", "dzicastate", &dzicastate, false, false, true}
...
{
    return "> ichibacoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2218/\n";
}
