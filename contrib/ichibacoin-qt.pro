...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/ichibacoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/ichibacoin-cli.cpp \
           src/ichibacoin-tx.cpp \
           src/ichibacoin.cpp \
           src/db.cpp \
           ...
           src/qt/ichibacoin.cpp \
           src/qt/ichibacoinstrings.cpp \
...
RESOURCES += src/qt/ichibacoin.qrc src/qt/ichibacoin_locale.qrc

TRANSLATIONS += src/qt/locale/ichibacoin_bg.ts \
                src/qt/locale/ichibacoin_de.ts \
                src/qt/locale/ichibacoin_en.ts \
                src/qt/locale/ichibacoin_es.ts \
                src/qt/locale/ichibacoin_fi.ts \
                src/qt/locale/ichibacoin_fr.ts \
                src/qt/locale/ichibacoin_it.ts \
                src/qt/locale/ichibacoin_ja.ts \
                src/qt/locale/ichibacoin_pl.ts \
                src/qt/locale/ichibacoin_pt.ts \
                src/qt/locale/ichibacoin_ru.ts \
                src/qt/locale/ichibacoin_sk.ts \
                src/qt/locale/ichibacoin_sv.ts \
                src/qt/locale/ichibacoin_vi.ts \
                src/qt/locale/ichibacoin_zh_CN.ts \
                src/qt/locale/ichibacoin_zh_TW.ts
