Contributing to IchibaCoin
============================

The IchibaCoin project operates an open contributor model where anyone is
...
The following applies to code changes to the IchibaCoin project, and is not to be
confused with overall IchibaCoin Network Protocol consensus changes.

Whether a pull request is merged into IchibaCoin rests with the project merge
...
Patches that change IchibaCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the IchibaCoin consensus, it must have been
...
The project leader is the release manager for each IchibaCoin release.
