...
This mechanism has been integrated into Bitcore-Node-IchibaCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/IchibaCoin-Project/insight-api-ichibacoin#web-socket-api](https://github.com/IchibaCoin-Project/insight-api-ichibacoin#web-socket-api) 
* API: [https://github.com/IchibaCoin-Project/insight-api-ichibacoin#swifttx-transactions](https://github.com/IchibaCoin-Project/insight-api-ichibacoin#swifttx-transactions) 
...
By default, the IchibaCoin daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the IchibaCoin daemon:
