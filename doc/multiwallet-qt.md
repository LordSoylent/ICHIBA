...
In order to support loading of multiple wallets in ichibacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ichibacoin.cpp.
...
Changes to ichibacoin.cpp
----------------------
ichibacoin.cpp is the entry point into ichibacoin-qt, and as such, will require some minor modifications to provide hooks for
